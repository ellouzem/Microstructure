...
param_pin = c("beta_t1", "AIM_t1", "log_market_cap_t1", "log_btm_t1", "fsrv_t1", "turnover_t1", "illiq_amihud_t1")
...
result1 = regression_table_FMB(param, n_param, param_pin)
...
result2 = regression_table_LR(param, n_param, param_pin)
